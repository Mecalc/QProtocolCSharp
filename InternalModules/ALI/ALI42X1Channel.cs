...
{
    [Serializable]
    public class ALI42X1Channel : DataChannelItem
    {
        public ALI42X1Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ALI42X1ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ALI42X1ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ALI42X1ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
