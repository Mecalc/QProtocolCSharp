...
{
    [Serializable]
    public class VIM450Channel : DataChannelItem
    {
        public VIM450Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class VIM450ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new VIM450ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<VIM450ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
