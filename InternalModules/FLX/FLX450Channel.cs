...
{
    [Serializable]
    public class FLX450Channel : DataChannelItem
    {
        public FLX450Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class FLX450ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new FLX450ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<FLX450ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
