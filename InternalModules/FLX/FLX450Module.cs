...
{
    [Serializable]
    public class FLX450Module : Item
    {
        public FLX450Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class FLX450ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<FLX450ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new FLX450ModuleOperationMode() {OperationMode = operationMode}),
            };
