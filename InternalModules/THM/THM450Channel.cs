...
{
    [Serializable]
    public class THM450Channel : DataChannelItem
    {
        public THM450Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class THM450ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new THM450ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<THM450ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
