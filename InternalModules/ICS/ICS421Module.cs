...
{
    [Serializable]
    public class ICS421Module : Item
    {
        public ICS421Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICS421ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICS421ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICS421ModuleOperationMode() {OperationMode = operationMode}),
            };
