...
{
    [Serializable]
    public class ICS450Module : Item
    {
        public ICS450Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICS450ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICS450ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICS450ModuleOperationMode() {OperationMode = operationMode}),
            };
