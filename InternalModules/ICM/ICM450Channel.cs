...
{
    [Serializable]
    public class ICM450Channel : DataChannelItem
    {
        public ICM450Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        public enum BufferedOutputTestSignal
        {
            [RestfulProperties("0 V")]
            _0V = 0,
        ...
        [Serializable]
        public class ICM450ChannelOperationMode
        {
        ...
        public class VoltageInputSettings : ISettings
        {
            ...
            [RestfulProperties("Buffered Output")]
            public GenericDefines.Generic.Status BufferedOutput { get; set; } = GenericDefines.Generic.Status.Disabled;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICM450ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICM450ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
