...
{
    [Serializable]
    public class CHS42X4Channel : DataChannelItem
    {
        public CHS42X4Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        public enum ChargeSensitivity
        {
            ...
            [RestfulProperties("10 µV/pC", 0.01, "")]
            _10uVppC = 2,
        }

        public enum ChargeCableShieldGround
        {
            [RestfulProperties("Shield Floating")]
            Floating = 0,

            [RestfulProperties("Shield Grounded")]
            Grounded = 1,
        }

        public enum ChargeInputCoupling
        {
            [RestfulProperties("AC With 1 Hz Filter")]
            AcWith1HzFilter = 0,
        }
        ...
        [Serializable]
        public class CHS42X4ChannelOperationMode
        {
        ...
        public class ChargeInputSettings : ISettings
        {
            ...
            [RestfulProperties("Charge Shield Grounding")]
            public ChargeCableShieldGround ChargeShieldGrounding { get; set; } = ChargeCableShieldGround.Floating;

            [RestfulProperties("Coupling")]
            public ChargeInputCoupling ChargeInputCoupling { get; set; } = ChargeInputCoupling.AcWith1HzFilter;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new CHS42X4ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<CHS42X4ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
