...
{
    [Serializable]
    public class ICT454IcpChannel : DataChannelItem
    {
        public ICT454IcpChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICT454IcpChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICT454IcpChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICT454IcpChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
