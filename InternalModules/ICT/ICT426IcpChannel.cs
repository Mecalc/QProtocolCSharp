...
{
    [Serializable]
    public class ICT426IcpChannel : DataChannelItem
    {
        public ICT426IcpChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICT426IcpChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICT426IcpChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICT426IcpChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
