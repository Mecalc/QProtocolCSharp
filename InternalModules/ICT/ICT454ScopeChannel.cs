...
{
    [Serializable]
    public class ICT454ScopeChannel : DataChannelItem
    {
        public ICT454ScopeChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICT454ScopeChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICT454ScopeChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICT454ScopeChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
