...
{
    [Serializable]
    public class ICT42S6TachoChannel : DataChannelItem
    {
        public ICT42S6TachoChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICT42S6TachoChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICT42S6TachoChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICT42S6TachoChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
