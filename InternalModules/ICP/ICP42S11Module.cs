...
{
    [Serializable]
    public class ICP42S11Module : Item
    {
        public ICP42S11Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICP42S11ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICP42S11ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICP42S11ModuleOperationMode() {OperationMode = operationMode}),
            };
