...
{
    [Serializable]
    public class ICP42S11Channel : DataChannelItem
    {
        public ICP42S11Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICP42S11ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICP42S11ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICP42S11ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
