...
{
    [Serializable]
    public class ICP4211Channel : DataChannelItem
    {
        public ICP4211Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICP4211ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICP4211ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICP4211ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
