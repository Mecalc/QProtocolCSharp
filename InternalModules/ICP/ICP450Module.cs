...
{
    [Serializable]
    public class ICP450Module : Item
    {
        public ICP450Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class ICP450ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<ICP450ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new ICP450ModuleOperationMode() {OperationMode = operationMode}),
            };
