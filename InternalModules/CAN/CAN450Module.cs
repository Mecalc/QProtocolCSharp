...
{
    [Serializable]
    public class CAN450Module : Item
    {
        public CAN450Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class CAN450ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<CAN450ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new CAN450ModuleOperationMode() {OperationMode = operationMode}),
            };
