...
{
    [Serializable]
    public class CAN450Channel : DataChannelItem
    {
        public CAN450Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class CAN450ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new CAN450ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<CAN450ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
