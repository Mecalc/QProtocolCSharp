...
{
    [Serializable]
    public class CAN42S2Channel : DataChannelItem
    {
        public CAN42S2Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class CAN42S2ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new CAN42S2ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<CAN42S2ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
