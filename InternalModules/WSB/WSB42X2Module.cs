...
{
    [Serializable]
    public class WSB42X2Module : Item
    {
        public WSB42X2Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class WSB42X2ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<WSB42X2ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new WSB42X2ModuleOperationMode() {OperationMode = operationMode}),
            };
