...
{
    [Serializable]
    public class WSB42X5Module : Item
    {
        public WSB42X5Module(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class WSB42X5ModuleOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<WSB42X5ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new WSB42X5ModuleOperationMode() {OperationMode = operationMode}),
            };
