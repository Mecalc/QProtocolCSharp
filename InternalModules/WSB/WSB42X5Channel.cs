...
{
    [Serializable]
    public class WSB42X5Channel : DataChannelItem
    {
        public WSB42X5Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class WSB42X5ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new WSB42X5ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<WSB42X5ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
