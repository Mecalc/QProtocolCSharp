...
{
    [Serializable]
    public class WSB42X2Channel : DataChannelItem
    {
        public WSB42X2Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class WSB42X2ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new WSB42X2ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<WSB42X2ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
