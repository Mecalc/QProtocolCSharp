...
{
    [Serializable]
    public class DCH450Channel : DataChannelItem
    {
        public DCH450Channel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class DCH450ChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new DCH450ChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<DCH450ChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
