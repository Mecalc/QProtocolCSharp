...
namespace QProtocol.DataStreaming.DataPackets
{
    ...
    /// </summary>
    public class TriggeredStatsPacket
    {
        ...
        /// </summary>
        public TriggeredStatsChannelHeader TriggeredStatsChannelHeader { get; }
        ...
        /// <param name="triggeredStatsChannelHeader">A reference to the Specific Channel Header.</param>
        ...
        public TriggeredStatsPacket(GenericChannelHeader genericChannelHeader, TriggeredStatsChannelHeader triggeredStatsChannelHeader, BinaryReader reader)
        {
            GenericChannelHeader = genericChannelHeader;
            TriggeredStatsChannelHeader = triggeredStatsChannelHeader;
        }
