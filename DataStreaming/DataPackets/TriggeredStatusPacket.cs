...
namespace QProtocol.DataStreaming.DataPackets
{
    ...
    /// </summary>
    public class TriggeredStatusPacket
    {
        ...
        /// </summary>
        public TriggeredStatusChannelHeader TriggeredStatusChannelHeader { get; }
        ...
        /// <param name="triggeredStatusChannelHeader">A reference to the Specific Channel Header.</param>
        ...
        public TriggeredStatusPacket(GenericChannelHeader genericChannelHeader, TriggeredStatusChannelHeader triggeredStatusChannelHeader, BinaryReader reader)
        {
            GenericChannelHeader = genericChannelHeader;
            TriggeredStatusChannelHeader = triggeredStatusChannelHeader;
        }
