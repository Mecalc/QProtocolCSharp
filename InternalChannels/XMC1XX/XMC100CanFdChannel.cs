...
{
    [Serializable]
    public class XMC100CanFdChannel : DataChannelItem
    {
        public XMC100CanFdChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class XMC100CanFdChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new XMC100CanFdChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<XMC100CanFdChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
