...
{
    [Serializable]
    public class XMC100IcpChannel : DataChannelItem
    {
        public XMC100IcpChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class XMC100IcpChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new XMC100IcpChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<XMC100IcpChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
