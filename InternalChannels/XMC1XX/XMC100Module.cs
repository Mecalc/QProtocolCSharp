...
namespace QProtocol.InternalChannels.XMC1XX
{
    [Serializable]
    public class XMC100Module : Item
    {
        public XMC100Module(Item itemInfo)
            : base(itemInfo)
        {
        }

        public const System.Int32 NumberOfIcpChannels = 4;
        public const System.Int32 NumberOfCanFdChannels = 1;
        ...
        public class ConfiguredChannels
        {
            ...
            public DeviceType XMC100DeviceType { get; set; }
        ...
        [Serializable]
        public class XMC100ModuleOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new XMC100ModuleOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<XMC100ModuleOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
