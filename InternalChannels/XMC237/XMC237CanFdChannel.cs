...
{
    [Serializable]
    public class XMC237CanFdChannel : DataChannelItem
    {
        public XMC237CanFdChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class XMC237CanFdChannelOperationMode
        {
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new XMC237CanFdChannelOperationMode() {OperationMode = operationMode}),
            };
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<XMC237CanFdChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
    }
}
