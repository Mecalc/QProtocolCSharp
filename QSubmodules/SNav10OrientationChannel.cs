...
{
    [Serializable]
    public class SNav10OrientationChannel : DataChannelItem
    {
        public SNav10OrientationChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class SNav10OrientationChannelOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<SNav10OrientationChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new SNav10OrientationChannelOperationMode() {OperationMode = operationMode}),
            };
