...
{
    [Serializable]
    public class SNav10LocationChannel : DataChannelItem
    {
        public SNav10LocationChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class SNav10LocationChannelOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<SNav10LocationChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new SNav10LocationChannelOperationMode() {OperationMode = operationMode}),
            };
