...
{
    [Serializable]
    public class SNav10TravelChannel : DataChannelItem
    {
        public SNav10TravelChannel(Item itemInfo)
            : base(itemInfo)
        {
        }
        ...
        [Serializable]
        public class SNav10TravelChannelOperationMode
        {
        ...
        public new OperationMode GetItemOperationMode()
        {
            ...
            return Setting.ConvertTo<SNav10TravelChannelOperationMode>(jsonObject.Settings).OperationMode;
        }
        ...
        public void PutItemOperationMode(OperationMode operationMode)
        {
            ...
            {
                Settings = Setting.ConvertFrom(new SNav10TravelChannelOperationMode() {OperationMode = operationMode}),
            };
